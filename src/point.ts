...
export class Point extends Geometry {
    ...
    toWkt(): string {
        ...
        return this.getWktType(GEOMETRY_TYPES.Point.wkt, false) + '(' + this.getWktCoordinate(this) + ')';
    }
    ...
    toWkb(parentOptions?: GeometryOptions): Buffer {
        ...
        wkb.writeInt8(1);
        this.writeWkbType(wkb, GEOMETRY_TYPES.Point.wkb as number, parentOptions);
    ...
    toTwkb(previousPoint?: Point): Buffer {
